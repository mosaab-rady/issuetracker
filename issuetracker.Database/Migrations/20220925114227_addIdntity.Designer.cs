...
namespace issuetracker.Database.Migrations
{
    ...
    [Migration("20220925114227_addIdntity")]
            ...
            modelBuilder.Entity("issuetracker.Entities.AppUser", b =>
                {
                    ...
                    b.HasIndex("IssueId")
                        .HasDatabaseName("ix_asp_net_users_issue_id");
                    ...
                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_asp_net_users_project_id");
            ...
            modelBuilder.Entity("issuetracker.Entities.Issue", b =>
                {
                    ...
                    b.HasIndex("CreatedById")
                        .HasDatabaseName("ix_issues_created_by_id");
            ...
            modelBuilder.Entity("issuetracker.Entities.AppUser", b =>
                {
                    b.HasOne("issuetracker.Entities.Issue", null)
                        ...
                        .HasConstraintName("fk_asp_net_users_issues_issue_id");

                    b.HasOne("issuetracker.Entities.Project", null)
                        .WithMany("AssignedTo")
                        .HasForeignKey("ProjectId")
                        .HasConstraintName("fk_asp_net_users_projects_project_id");
                });

            modelBuilder.Entity("issuetracker.Entities.Issue", b =>
                {
                    b.HasOne("issuetracker.Entities.AppUser", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .HasConstraintName("fk_issues_users_created_by_id");
